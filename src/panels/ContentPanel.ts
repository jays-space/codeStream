...
/**
 * This class manages the state and behavior of Content webview panels.
 *
 * It contains all the data and methods for:
 *
 * - Creating and rendering Content webview panels
 * - Properly cleaning up and disposing of webview resources when the panel is closed
 * - Setting the HTML (and by proxy CSS/JavaScript) content of the webview panel
 * - Setting message listeners so data can be passed between the webview and extension
 */
export class ContentPanel {
  public static currentPanel: ContentPanel | undefined;
  private readonly _panel: WebviewPanel;
  private _disposables: Disposable[] = [];

  /**
   * The ContentPanel class private constructor (called only from the render method).
   *
  ...
  public static render(extensionUri: Uri, title: string) {
    if (ContentPanel.currentPanel) {
      ...
      ContentPanel.currentPanel = new ContentPanel(panel, extensionUri);
    }
  }

/**
 * The `kill` function disposes of the current content panel and sets it to undefined.
 */
  public static kill() {
    ContentPanel.currentPanel?.dispose();
      ...
      (message: any) => {
        ...
        switch (command) {
          case "SHOW_MAIN_CONTENT":
            // Code that should run in response to the SHOW_MAIN_CONTENT message command
